  ...
  Widget build(BuildContext context) {
    return context.read<NetworkStatus>() == NetworkStatus.offline
        ? imageData != null
            ...
            : buildContainer(AssetImage(AppImages.image_placeholder), BoxFit.fill, Colors.grey.shade100)
        : CachedNetworkImage(
      imageUrl: url,
            errorWidget: (context, url, error) => buildContainer(AssetImage(AppImages.image_placeholder), BoxFit.fill, Colors.grey.shade100, border, boxShadow),
